...
Grievance Service	Node.js (integrated router)	Complaint management
...
Worker sees verified earnings
Advocate monitors aggregated trends
Worker generates income certificate
Design Decisions
